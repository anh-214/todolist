<template>
    <div>
        ...
        <!-- <el-table :data="filterData(todos)" border style="width: 100%">
            ...
            <el-table-column label="Hành động">
                <el-button size="mini" type="primary" @click="handleDetail(scope.$index, scope.row)">Detail</el-button>
                <el-button size="mini" type="success" @click="changeStatus(scope.$index, scope.row)">Change Status
                </el-button>
            </el-table-column>
        </el-table>
        <slot></slot> -->
